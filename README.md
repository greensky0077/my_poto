# Elliot - Full-Stack Developer Portfolio

## Overview

This repository contains the source code of my professional portfolio, a React progressive web app showcasing my skills, projects, and experience as a Full-Stack Developer. Built with *MUI Joy* for UI components, *React Spring* for animations, and modern web technologies.

I'm an experienced Full-Stack Developer with 5+ years of experience building modern web applications, SaaS platforms, and AI-powered solutions. I specialize in React, Node.js, Python, and automation workflows that help businesses scale faster and smarter.

**Key Expertise:**
- Full-Stack Development (React, Node.js, Python, TypeScript)
- Workflow Automation & API Integrations (Zapier, Make, custom scripts)
- AI Integration (OpenAI, LangChain, Chatbots, RAG systems, custom AI agents)
- Cloud Deployment (AWS, Vercel, Google Cloud, CI/CD)
- WhatsApp Business API Integration
- eCommerce Customization (Tray API)
...
This portfolio is a frontend-only application that showcases my work and skills. It connects to various APIs and services for contact forms and analytics.

The application is designed to be deployed as a static site and can be hosted on platforms like Vercel, Netlify, or any static hosting service.
