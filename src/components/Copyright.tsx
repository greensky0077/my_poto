 ...
 * contact the author for clarification, by [filing an issue](https://github.com/Eliot/Eliot.fr/issues/new).
 *
...
export default function Copyright() {
  ...
  const isAuthorDomain = ["Eliot.fr", "www.Eliot.fr"].includes(
  ...
  return isAuthorDomain ? null : (
    ...
    >
      ...
      >
        Credit to{" "}
        <Link href="https://github.com/Eliot" target="_blank">
          Eliot
        </Link>{" "}
        for the{" "}
        <Link href="https://www.Eliot.fr" target="_blank">
          original design
        </Link>{" "}
        and{" "}
        <Link href="https://github.com/Eliot/Eliot.fr" target="_blank">
          code
        </Link>
        .
      </Typography>
